      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo ROOT_URL_PREV.'en'."/".$controller."/".$action."/".$id; ?>"><button type="button" class="btn btn-default btn-xs">বাংলা</button></a></li>
