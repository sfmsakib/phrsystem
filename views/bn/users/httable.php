          ...
          <div class="col-lg-12" style="padding: 0px;">
                    ...
                    <div class=" table-responsive" style="padding: 0px;background-color: #fff;">
                                    <table class="table table-bordered table-striped" class="small">
                                        ...
                                        <tbody >
                                       <?php foreach($_SESSION['ht_measurement'] as $bpre) : ?>
                                            <tr class="small">
                                                <td><?php  echo $bpre['htdom']; ?></td>
                                                <td><?php echo $bpre['httom']; ?></td>
                                                <td><?php echo $bpre["height"]; ?> cm</td>
                                                <td><?php echo $bpre["htnote"] ;?></td>
                                                <td> 
        <form class="pull-right" method="POST" action="">
            <input type="hidden" name="htdelete_id" value="<?php echo $bpre['htid']; ?>">
           <i class="material-icons text-white"> <input classs="btn-floating waves-effect waves-light btn red tooltipped" class="btn btn-danger" name="htdelete" type="submit" value="delete" /></i>
        </form>
                                                </td>
                                            </tr>
