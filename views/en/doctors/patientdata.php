                                    ...
                                    <div class="dropdown show">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                       <!-- <a class="dropdown-item" href="<?php// echo ROOT_URL; ?>users/bptable">Table View</a> -->
                                        <a class="dropdown-item" href="<?php echo ROOT_URL; ?>input/patbpinput">Add Another Measurement</a>
                                      </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="background-color: #9E9E9E ;padding-top: 15px;padding-bottom: 10px;border-radius: 9px 9px 9px 9px;margin-left: -2px;margin-right: -2px;margin-top: -2px;">
                                ...
                                <div class="col-md-12 " >
                                    <div class="list-group-item">
                                        ...
                                        <a class="dropdown-item text-center" href="<?php echo ROOT_URL; ?>input/patbpinput">Add Measurement</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="dropdown show">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                       <!-- <a class="dropdown-item" href="<?php// echo ROOT_URL; ?>users/wttable">Table View</a> -->
                                        <a class="dropdown-item" href="<?php echo ROOT_URL; ?>input/patwtinput">Add Another Measurement</a>
                                      </div>
                                    </div>
                                </div>
                            </div>
